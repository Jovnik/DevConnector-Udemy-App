...
import { Link, withRouter } from 'react-router-dom' //with Router allows us to redirect from an action
...
// withRouter is required for the history prop to be accessible
